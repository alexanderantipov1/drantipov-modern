...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "How Aetna dental insurance applies to dental implants, oral surgery, and orthognathic procedures.",
    images: [
      {
        url: "/images/financial/insurance-coverage.jpg",
        width: 1200,
        height: 630,
        alt: "Aetna Implant Coverage",
      },
    ],
  },
  twitter: {
    ...
    <>
      <section className="relative bg-dark text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/landing-pages/dental-implants/art/office01-d1051d16.jpg" alt="Aetna coverage" fill className="object-cover opacity-30" priority sizes="100vw" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          <nav aria-label="Breadcrumb" className="text-sm text-white/60 mb-6">
            <ol className="flex flex-wrap items-center gap-2">
              ...
              <li aria-hidden="true">/</li>
              <li className="text-white font-semibold">Aetna</li>
            </ol>
          </nav>
          <p className="text-sm font-bold uppercase tracking-[0.25em] text-primary-light">Aetna Dental</p>
          <h1 className="mt-4 font-serif text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
            Using Aetna with Dr. Antipov
          </h1>
          <p className="mt-6 max-w-3xl text-xl leading-relaxed text-white/85">
            Dr. Antipov is an out-of-network provider for Aetna. Patients with PPO plans typically receive partial reimbursement. Our insurance coordinator handles pre-authorization and claim submission at no cost to you.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-10">
          <div>
            <h2 className="font-serif text-3xl font-bold text-neutral-900 mb-4">What Aetna typically covers</h2>
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-700 leading-7">
              <li><strong>Verification:</strong> We call Aetna on your behalf to confirm your specific benefits and remaining annual maximum.</li>
