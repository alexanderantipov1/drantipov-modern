...
export default function FacialCosmeticSurgeryPage() {
  const structuredData = [
    ...
    ]),
    {
      ...
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Rhinoplasty" },
        { "@type": "ListItem", position: 2, name: "Face Lift Surgery" },
        { "@type": "ListItem", position: 3, name: "Eyelid Surgery (Blepharoplasty)" },
        { "@type": "ListItem", position: 4, name: "Double Eyelid Surgery" },
        { "@type": "ListItem", position: 5, name: "Facial Feminization Surgery" },
        { "@type": "ListItem", position: 6, name: "Juvederm Dermal Fillers" },
        { "@type": "ListItem", position: 7, name: "Lip Augmentation" },
        { "@type": "ListItem", position: 8, name: "Scarless Mole Removal" },
      ],
    },
    {
      "@context": "https://schema.org",
