...
const stats = [
  {
    ...
    description: "Dental implants, jaw surgery & cosmetic procedures",
    icon: (
  ...
  },
  {
    ...
    description: "Board-certified surgical expertise since 1999",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    suffix: "+",
    label: "Cities Served",
    description: "Patients travel from across Northern California & Nevada",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    value: 100,
    suffix: "+",
    label: "Referring Dentists",
    description: "Trusted by dental professionals across the region",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
