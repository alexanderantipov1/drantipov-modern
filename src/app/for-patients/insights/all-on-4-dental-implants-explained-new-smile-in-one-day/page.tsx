...
export const metadata: Metadata = {
  title: { absolute: "All-on-4® Dental Implants Explained: Same-Day Smile" },
  description:
    "Learn how All-on-4 full arch dental implants restore your smile with same day fixed teeth including candidacy, procedure steps, and results in Roseville.",
  alternates: {
  ...
  openGraph: {
    title: "All-on-4® Dental Implants Explained: Same-Day Smile",
