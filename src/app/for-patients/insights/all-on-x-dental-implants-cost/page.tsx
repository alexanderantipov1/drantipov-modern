...
export const metadata: Metadata = {
  ...
  description:
    "What All-on-X really means, how cost differs between 4, 6, and 8 implants per arch, what's included in a quote, and how to decide what your case actually needs.",
  alternates: {
