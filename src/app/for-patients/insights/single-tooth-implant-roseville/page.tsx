...
export const metadata: Metadata = {
  title: { absolute: "Single Tooth Implant in Roseville: Complete Patient Guide" },
  description:
    "Single tooth implants replace missing teeth without altering adjacent teeth: Dr. Antipov in Roseville explains the process, bone protection, costs & recovery.",
  alternates: {
  ...
  openGraph: {
    title: "Single Tooth Implant in Roseville: Complete Patient Guide",
        ...
        <Container size="lg">
          <article className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-neutral-900 mb-6 leading-tight">
              Single Tooth Implant in Roseville: Complete Patient Guide
            </h1>
