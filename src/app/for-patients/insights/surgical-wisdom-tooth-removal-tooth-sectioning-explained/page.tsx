...
export const metadata: Metadata = {
  ...
  description:
    "How impacted wisdom teeth are removed with tooth sectioning — why the tooth is divided, the step-by-step procedure, recovery, and when surgical extraction is recommended, from Dr. Antipov in Roseville.",
  alternates: {
