            ...
            <div className="prose prose-lg max-w-none">
              ...
              <GlassCard className="my-10 p-6">
                ...
                <ul className="mt-3 space-y-2 text-base leading-7 text-neutral-700 list-none pl-0">
                  ...
                  <li>&bull; Only experienced <Link href="/about-us" className="text-primary-700 hover:text-primary-800 font-semibold">oral &amp; maxillofacial surgeons</Link> perform this technique.</li>
                </ul>
              </GlassCard>
              ...
              <p className="text-neutral-700 leading-relaxed mb-6">
                ...
                general-dentistry procedure. <Link href="/about-us" className="text-primary-700 hover:text-primary-800 font-semibold">Dr. Antipov</Link> is:
              </p>
              <ul className="space-y-3 text-neutral-700 leading-relaxed mb-6 list-none pl-0">
