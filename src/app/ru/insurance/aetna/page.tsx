...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/ru/insurance/aetna",
    languages: {
      ru: "/ru/insurance/aetna",
      en: "/insurance/aetna",
      "x-default": "/insurance/aetna",
    },
  },
  openGraph: {
    title: "Покрытие имплантов по Aetna",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Покрытие имплантов по Aetna",
      },
    ],
  },
  twitter: {
    ...
    <>
      <section className="relative bg-dark text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/landing-pages/dental-implants/art/office01-d1051d16.jpg" alt="Покрытие Aetna" fill className="object-cover opacity-30" priority sizes="100vw" />
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-10">
          <div>
            <h2 className="font-serif text-3xl font-bold text-neutral-900 mb-4">Что Aetna обычно покрывает</h2>
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-700 leading-7">
              <li><strong>Проверка покрытия:</strong> Мы сами звоним в Aetna, чтобы уточнить ваши конкретные бенефиты и остаток годового максимума.</li>
