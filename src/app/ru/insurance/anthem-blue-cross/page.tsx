...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/ru/insurance/anthem-blue-cross",
    languages: {
      ru: "/ru/insurance/anthem-blue-cross",
      en: "/insurance/anthem-blue-cross",
      "x-default": "/insurance/anthem-blue-cross",
    },
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Покрытие Anthem Blue Cross",
      },
    ],
  },
  twitter: {
    ...
    <>
      <section className="relative bg-dark text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/landing-pages/dental-implants/art/office01-d1051d16.jpg" alt="Покрытие Anthem Blue Cross" fill className="object-cover opacity-30" priority sizes="100vw" />
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-10">
          <div>
            <h2 className="font-serif text-3xl font-bold text-neutral-900 mb-4">Что Anthem Blue Cross обычно покрывает</h2>
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-700 leading-7">
              <li><strong>Проверка покрытия:</strong> Мы сами звоним в Anthem Blue Cross, чтобы уточнить ваши конкретные бенефиты и остаток годового максимума.</li>
