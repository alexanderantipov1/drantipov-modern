...
export default function RuFacialCosmeticSurgeryPage() {
  const structuredData = [
    ...
    ]),
    {
      ...
      url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery`,
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Ринопластика", item: { "@type": "MedicalProcedure", name: "Ринопластика", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 2, name: "Подтяжка лица", item: { "@type": "MedicalProcedure", name: "Подтяжка лица", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 3, name: "Блефаропластика", item: { "@type": "MedicalProcedure", name: "Блефаропластика", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 4, name: "Азиатская блефаропластика", item: { "@type": "MedicalProcedure", name: "Азиатская блефаропластика", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 5, name: "Феминизация лица", item: { "@type": "MedicalProcedure", name: "Феминизация лица", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 6, name: "Филлеры Juvederm", item: { "@type": "MedicalProcedure", name: "Филлеры Juvederm", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 7, name: "Увеличение губ", item: { "@type": "MedicalProcedure", name: "Увеличение губ", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
        { "@type": "ListItem", position: 8, name: "Бесшрамное удаление родинок", item: { "@type": "MedicalProcedure", name: "Бесшрамное удаление родинок", url: `${siteUrl}/ru/surgical-cases/facial-cosmetic-surgery` } },
      ],
    },
    {
      "@context": "https://schema.org",
