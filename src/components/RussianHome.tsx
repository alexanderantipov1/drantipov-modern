...
const implantSequence = [
  ...
  { src: "/images/hero/02-blood-clot.jpg", label: "Естественное заживление", step: "Шаг 2" },
  { src: "/images/hero/03-bone-graft-placed.jpeg", label: "Костная пластика", step: "Шаг 3" },
  { src: "/images/hero/04-bone-graft-healing.jpg", label: "Интеграция трансплантата", step: "Шаг 4" },
      ...
      <header className="sticky top-0 z-50 border-b border-dark/10 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-6 text-sm font-semibold text-muted md:flex">
            ...
            <Link href="/ru/for-patients" className="transition hover:text-primary">Гиды</Link>
            ...
            <Link href="/ru/insurance" className="transition hover:text-primary">Страховка</Link>
