...
const cosmeticCases: CaseData[] = [
  { id: "fcs000001", label: "Кейс 1", title: "Бесшрамное удаление родинки на носу", description: "Precise excision of a prominent nasal mole using advanced scarless surgical technique. No visible scarring, natural result.", images: ["/images/cases/facial-cosmetic-surgery/fcs000001/1/gallery@2x-8e293739.jpg","/images/cases/facial-cosmetic-surgery/fcs000001/2/gallery@2x-20910af7.jpg","/images/cases/facial-cosmetic-surgery/fcs000001/3/gallery@2x-95d964d6.jpg","/images/cases/facial-cosmetic-surgery/fcs000001/4/gallery@2x-a409dfe0.jpg"] },
  { id: "fcs000002", label: "Кейс 2", title: "Бесшрамное удаление родинки на шее", description: "Removal of a large neck mole using minimally invasive technique with no visible scarring post-healing.", images: ["/images/cases/facial-cosmetic-surgery/fcs000002/1/gallery@2x-deb50b84.jpg"] },
  { id: "fcs000003", label: "Кейс 3", title: "Дермальные филлеры Juvederm - омоложение лица", description: "Non-surgical facial rejuvenation using Juvederm dermal fillers to restore volume, smooth wrinkles, and enhance facial contours.", images: ["/images/cases/facial-cosmetic-surgery/fcs000003/1/gallery@2x-a8f1f25e.jpg"] },
  { id: "fcs000004", label: "Кейс 4", title: "Филлеры Juvederm для губ - естественное увеличение", description: "Lip augmentation with Juvederm filler for natural-looking volume enhancement, improved symmetry, and defined lip borders.", images: ["/images/cases/facial-cosmetic-surgery/fcs000004/1/gallery@2x-7b89404d.jpg","/images/cases/facial-cosmetic-surgery/fcs000004/2/gallery@2x-32d085a7.jpg","/images/cases/facial-cosmetic-surgery/fcs000004/3/gallery@2x-3bb43f40.jpg","/images/cases/facial-cosmetic-surgery/fcs000004/4/gallery@2x-3be58dde.jpg"] },
  { id: "fcs000005", label: "Кейс 5", title: "Подтяжка лица с блефаропластикой верхних и нижних век", description: "Comprehensive facial rejuvenation combining rhytidectomy (face lift) with upper and lower blepharoplasty (eyelid surgery) for a naturally youthful appearance.", images: ["/images/cases/facial-cosmetic-surgery/fcs000005/1/gallery@2x-5a50101b.jpg","/images/cases/facial-cosmetic-surgery/fcs000005/2/gallery@2x-a2007315.jpg","/images/cases/facial-cosmetic-surgery/fcs000005/3/gallery@2x-c3f137d8.jpg","/images/cases/facial-cosmetic-surgery/fcs000005/4/gallery@2x-e27e6f5d.jpg"] },
...
const categories: { key: Category; label: string; count: number; cases: CaseData[] }[] = [
  { key: "jaw", label: "Челюстная хирургия", count: jawCases.length, cases: jawCases },
  { key: "implants", label: "Имплантация", count: implantCases.length, cases: implantCases },
  { key: "cosmetic", label: "Эстетика лица", count: cosmeticCases.length, cases: cosmeticCases },
];
              ...
              >
                ...
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-dark/70 to-transparent pt-6 pb-2 px-2">
                  <span className="text-white text-[10px] sm:text-xs font-semibold">
                    {i === 0 ? "До" : i === count - 1 ? "После" : `Этап ${i + 1}`}
                  </span>
                </div>
              </button>
            ))}
        ...
        <div className="px-5 py-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted">{categoryLabel} &bull; {caseData.label} &bull; {count} фото</p>
            </div>
...
export default function RuBeforeAfter() {
  ...
  return (
    <section id="before-after" lang="ru" className="py-16 lg:py-20 bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-muted text-lg">
            Смотрите {jawCases.length + implantCases.length + cosmeticCases.length} реальных кейсов: корректирующая хирургия челюстей, имплантация и эстетические процедуры лица, выполненные доктором Антиповым.
          </p>
        </motion.div>
        ...
        {activeCat.cases.length > 6 && (
          <div className="mt-8 text-center">
            ...
            >
              {showAll
                ? "Свернуть"
                : `Показать все ${activeCat.cases.length} кейсов`}
            </button>
          </div>
        )}
