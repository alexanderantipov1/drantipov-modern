...
function Star() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4 sm:h-[15px] sm:w-[15px]" fill="#F5A623" stroke="#F5A623" strokeWidth={1} aria-hidden="true">
...
export default function RuReviewBanner({
  ...
  return (
    <section className={`w-full bg-[#0a1929] ${className}`} lang="ru">
