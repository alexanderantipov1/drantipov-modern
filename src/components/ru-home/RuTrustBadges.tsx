...
const badges = [
  ...
  { label: "3D CT-навигация", icon: "tech" },
  { label: "IV-седация (лицензия)", icon: "heart" },
  { label: "Бесплатная консультация", icon: "check" },
  { label: "Финансирование", icon: "dollar" },
];
...
function BadgeIcon({ type }: { type: string }) {
  switch (type) {
    ...
    default:
      return (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
          <path strokeLinecap="round" strokeLinejoin="round" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812z" />
        </svg>
      );
  }
}

export default function RuTrustBadges() {
  return (
    <section className="py-8 bg-light border-y border-dark/5">
