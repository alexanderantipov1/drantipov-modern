...
export default function RuWallOfSmiles() {
  const [paused, setPaused] = useState(false);

  return (
    <section className="py-14 lg:py-20 bg-white overflow-hidden" lang="ru">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-10">
        ...
        <p className="mt-3 text-neutral-600 max-w-2xl mx-auto">
          Каждая улыбка на этой стене - пациент, который доверил доктору Антипову
          вернуть уверенность в себе с помощью имплантации и реконструкции
      ...
      <div className="smile-marquee group relative">
        ...
        <button
          ...
          aria-pressed={paused}
          aria-label={paused ? "Возобновить прокрутку улыбок" : "Поставить прокрутку на паузу"}
