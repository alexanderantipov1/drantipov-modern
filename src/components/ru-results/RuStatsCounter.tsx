...
const stats = [
  {
    ...
    suffix: "+",
    label: "Пациентов",
    description: "Имплантация, хирургия челюсти и эстетика",
    icon: (
  ...
  },
  {
    ...
    suffix: "+",
    label: "Лет опыта",
    description: "Сертифицированная хирургическая практика с 1999 года",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    value: 157,
    suffix: "+",
    label: "Городов обслуживаем",
    description: "Пациенты приезжают со всей Северной Калифорнии и Невады",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    value: 100,
    suffix: "+",
    label: "Стоматологов-партнёров",
    description: "Нам доверяют направления стоматологи региона",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function RuStatsCounter() {
  return (
