...
export const regions: Region[] = [
  {
    ...
    cities: [
      ...
      { name: "Citrus Heights", drive: "15 min" },
      { name: "Orangevale", drive: "15 min" },
      { name: "Fair Oaks", drive: "20 min" },
      { name: "Carmichael", drive: "22 min" },
      { name: "Rancho Cordova", drive: "25 min" },
      { name: "Elk Grove", drive: "35 min" },
      { name: "North Highlands", drive: "18 min" },
      { name: "Antelope", drive: "12 min" },
      { name: "Arden-Arcade", drive: "22 min" },
      { name: "West Sacramento", drive: "30 min" },
      { name: "El Dorado Hills", drive: "25 min" },
      { name: "Cameron Park", drive: "35 min" },
      { name: "Loomis", drive: "12 min" },
      { name: "Auburn", drive: "22 min" },
      { name: "Woodland", drive: "40 min" },
      { name: "Davis", drive: "40 min" },
      { name: "Placerville", drive: "40 min" },
      { name: "Galt", drive: "45 min" },
    ],
  },
  {
