...
const heroContent: Record<string, HeroContent> = {
  ...
  "/surgical-cases": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "Surgical Cases" }],
  },
  "/surgical-cases/dental-implants": {
    ...
    overlay: "dark",
    breadcrumbs: [{ name: "Surgical Cases", href: "/surgical-cases" }, { name: "Dental Implants" }],
  },
  "/surgical-cases/corrective-jaw-surgery": {
    ...
    overlay: "dark",
    breadcrumbs: [{ name: "Surgical Cases", href: "/surgical-cases" }, { name: "Corrective Jaw Surgery" }],
  },
  "/surgical-cases/facial-cosmetic-surgery": {
    ...
    overlay: "dark",
    breadcrumbs: [{ name: "Surgical Cases", href: "/surgical-cases" }, { name: "Facial Cosmetic Surgery" }],
  },
  ...
  "/for-patients": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Patients" }],
  },
  "/insurance": {
    image: "/images/landing-pages/dental-implants/art/office01-d1051d16.jpg",
    eyebrow: "Insurance & Financing",
    title: "Make Treatment Affordable",
    subtitle:
      "We accept most major PPO plans, offer transparent fee schedules, and partner with CareCredit and Cherry to spread payments over time.",
    overlay: "navy",
    breadcrumbs: [{ name: "Insurance & Financing" }],
  },
  "/for-patients/faqs": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Patients", href: "/for-patients" }, { name: "FAQs" }],
  },
  ...
  "/for-patients/insights": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Patients", href: "/for-patients" }, { name: "Insights" }],
  },
  "/for-patients/pre-op": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Patients", href: "/for-patients" }, { name: "Pre-Op Instructions" }],
  },
  "/for-patients/post-op": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Patients", href: "/for-patients" }, { name: "Post-Op Instructions" }],
  },
  ...
  "/for-dentists/refer-patients": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Dentists", href: "/for-dentists" }, { name: "Refer Patients" }],
  },
  "/for-dentists/referral-partners": {
    ...
    overlay: "navy",
    breadcrumbs: [{ name: "For Dentists", href: "/for-dentists" }, { name: "Referral Partners" }],
  },
